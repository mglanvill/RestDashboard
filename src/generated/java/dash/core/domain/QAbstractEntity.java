...
public class QAbstractEntity extends EntityPathBase<AbstractEntity> {
    ...
    private static final long serialVersionUID = -1988486148L;

    public static final QAbstractEntity abstractEntity = new QAbstractEntity("abstractEntity");

    public final DateTimePath<java.util.Date> createdD = createDateTime("createdD", java.util.Date.class);

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final DateTimePath<java.util.Date> modificatedD = createDateTime("modificatedD", java.util.Date.class);

    public final NumberPath<Long> userChanged = createNumber("userChanged", Long.class);
